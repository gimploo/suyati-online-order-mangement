    ...
    return (
        <div class="w-full bg-suyati-blue p-8 ">
            <div class="flex md:w-80 md:mx-auto rounded-lg md:shadow-lg justify-center py-10 items-center bg-white">
                <form onSubmit={login} class="bg-white">
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input name='email' class="pl-2 outline-none border-none" type="text" placeholder="Email Address" />
                    </div>
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                        ...
                        <input name='password' class="pl-2 outline-none border-none" type="password" placeholder="Password" />
                    </div>
                    <div class='my-4 '>
